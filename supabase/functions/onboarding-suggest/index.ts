...
const DETECT_SYSTEM = [
  ...
  "  name is known.",
  "- markets: the country/countries this operator OPERATES IN, using ONLY allowed",
  "  values. Use ANY of these signals: ccTLD (.ng, .co.ke, .co.za, .ug, .co.uk…),",
  "  on-page currency/licence/regulator/phone prefix, OR — importantly — YOUR OWN",
  "  KNOWLEDGE of this betting operator. If you recognise the brand, state the",
  "  market(s) it is known to operate in EVEN WITH NO on-page evidence (e.g.",
  "  'betvita' → Uganda). A .com domain does NOT mean 'no market' — infer it from",
  "  the operator's name and your knowledge. Prefer your single best-guess market",
  "  over an empty array; return empty ONLY if the brand is completely unknown to",
  "  you AND the page gives no signal whatsoever.",
...
const SYSTEM = [
  ...
  "- markets: if you are given CONFIRMED markets, echo them. If NONE are given,",
  "  determine the operator's market(s) YOURSELF from the domain, homepage, or your",
  "  knowledge of this betting brand (e.g. 'betvita' → Uganda) — never leave it",
  "  empty just because the domain is a .com. Always return the market(s) you used.",
  "- competitors: up to 8 online-gambling operators that actually compete with this",
  "  brand IN ITS MARKET(S). Use your knowledge of the market's operators — you do",
  "  NOT need SERP evidence to suggest well-known local betting brands.",
